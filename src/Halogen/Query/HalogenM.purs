...
-- | A unique identifier for a component which specifies its position in the
-- | component tree.
newtype ComponentId = ComponentId (List Int)

derive newtype instance eqComponentId :: Eq ComponentId
